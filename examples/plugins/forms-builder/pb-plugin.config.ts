  ...
  resources: [
    {
      ...
      fields: [
        { id: 'form-id',       label: 'Form',         type: 'text',     required: true },
        { id: 'page-path',     label: 'Page Path',    type: 'text' },
        { id: 'submitted-at',  label: 'Submitted At', type: 'date' },
        { id: 'payload',       label: 'Payload',      type: 'longtext' },
        { id: 'ip-hash',       label: 'IP Hash',      type: 'text' },
        { id: 'user-agent',    label: 'User Agent',   type: 'text' },
        { id: 'status',        label: 'Status',       type: 'text' },
        { id: 'error-message', label: 'Error',        type: 'text' },
      ],
    },
  ],
